...
(function() {
	...
	__C.mix(Array.prototype, {
		...
		random: function() {
			var n, t, F, i, _c = this.slice(), l = _c.length;
            for (i = l ; i--;) {
	...
	var Class = function(classPath, props) {
        ...
        if (ini.ready === true || ini.ready === false) {
            ini.single = true;
            ini.ready ? __C.ready(clazz) : clazz()
        }
